...
export const en: Messages = {
	...
	panel: {
		...
		literature: "Literature receipts",
		literatureHint:
			"Identity checks only (DOI, Zotero item, Vault note); not proof the full text was read or the science verified.",
		lit: {
			...
			openDoi: "DOI page",
			verified: "Verified",
			unverified: "Written, not read back",
			...
			attachmentIndexed: "PDF attached (not read)",
			saved: "Saved",
			reused: "Existing item reused",
			bothVerified: "Both identities verified",
			partial: "Partially verified",
			channelConnector: "via Zotero desktop",
			channelWeb: "via Web API",
		},
		zoteroEvidence: {
			found: "Zotero item {key} found",
			notFound: "DOI not found in Zotero",
			ambiguous: "Several Zotero items share this DOI",
			unavailable: "Zotero check unavailable: {reason}",
			pending: "Awaiting Zotero read-back",
			local: "local",
			web: "cloud",
		},
	},
