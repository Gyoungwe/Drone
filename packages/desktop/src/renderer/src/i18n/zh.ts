...
export const zh = {
	...
	panel: {
		...
		literature: "文献回执",
		literatureHint: "只核对 DOI、Zotero 条目与 Vault 笔记的身份；不代表读过全文或科学结论已核验。",
		lit: {
			vaultNote: "Vault 笔记",
			fulltext: "全文",
			...
			unknown: "未核对",
			metadataOnly: "仅元数据",
			attachmentIndexed: "有 PDF 附件（未读）",
			saved: "已写入",
			reused: "复用已有条目",
			bothVerified: "双库身份已核对",
			partial: "部分核对",
			channelConnector: "经 Zotero 桌面",
			channelWeb: "经 Web API",
		},
		zoteroEvidence: {
			found: "Zotero 已找到条目 {key}",
			notFound: "Zotero 中未找到该 DOI",
			ambiguous: "Zotero 中有多条同 DOI 条目",
			unavailable: "Zotero 暂不可核对：{reason}",
			pending: "待 Zotero 读回核对",
			local: "本机",
			web: "云端",
		},
	},
