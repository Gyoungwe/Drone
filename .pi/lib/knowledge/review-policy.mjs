...
export const advisoryCodes = new Set([
 "search-required", "coverage-incomplete", "wiki-changed", "citation-required",
 "source-unread", "source-changed", "delivery-changed", "search-stale", "check-timeout",
 "not-prepared", "citation-invalid", "citation-budget",
]);
